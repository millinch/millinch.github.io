...
var convertTextButton, paneSetting;
...
function startGui() {
	...
	// build the converter
	converter = new Showdown.converter({ extensions: ['prettify','table'] });
...
function convertText() {
	...
	//output that was prettified
	if (paneSetting.value == "outputPane") {
		// the output pane is selected
		outputPane.value = previewPane.innerHTML;
	}
};
...
function onPaneSettingChanged() {
	...
	if (paneSetting.value == "outputPane") {
		// Update output pane , previewPane is always the latest
		outputPane.value = previewPane.innerHTML;
	} else if (paneSetting.value == "previewPane") {
		// Update preview pane
		previewPane.innerHTML = outputPane.value;
	}
}
...
function setPaneHeights() {
	...
	var footer = document.getElementById("gui-footer");
